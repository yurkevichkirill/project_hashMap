import { LinkedListToSet } from "./linked_list_to_set.js";
...
export class HashSet{
    constructor(loadFactor = 0.75, capacity = 16){
        ...
        for(let i = 0; i < this.capacity; i++){
            this.buckets[i] = new LinkedListToSet();
        }
    }
    ...
    set(key){
        ...
        if(this.buckets[index].size() === 0 || !this.buckets[index].contains(key)){
    ...
    keys(){
        ...
        this.buckets.forEach((bucket) => {
            ...
            while(listIndex < bucket.size()){
                keys.push(bucket.at(listIndex++).data);
            }
        });
        return keys;
    }
